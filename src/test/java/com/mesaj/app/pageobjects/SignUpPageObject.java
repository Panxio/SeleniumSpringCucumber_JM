...
public class SignUpPageObject {
    ...
    private By addres = By.xpath("textarea[@ng-model='Adress']");
    ...
    private By country = By.xpath("//select[@ng-model='country']");
    ...
    public void go(String url){this.driver.get(url);}//Metodo que recibe un url y en la cual se navegara
    ...
    public void writeAddres (String address){
        this.driver.findElement(this.addres).sendKeys(address);
    }
